...
import { Award, BadgeCheck, HeartHandshake, Home, Trophy } from "lucide-react";
  ...
  return (
    <section className="py-24 pb-0 md:pb-24 w-full overflow-hidden bg-white">
      <div className="max-w-screen-md mx-auto">
        ...
        >
          ...
          <div className="flex flex-col md:flex-row md:gap-2 gap-3">
            {[
              ...
              // 260923 가맹전환 — SGI 보증보험 뱃지 뺀 자리에 KS 제품인증(KCL-17-408) 추가
              { text: "KS 제품인증", text2: "취득", icon: BadgeCheck, color: "#10B981" },
        ...
        {/* 260923 가맹전환 — 그린리모델링(등록사업자 본사 명의 신청)은 가맹점 계약에 적용할 수 없어 블록 삭제 */}
